...
const UserDialog = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left w-full">
      <div>
        <Menu.Button className="flex w-full justify-center items-center space-x-4 px-3 py-2 text-xl">
            <FaUser className=' text-slate-700 text-2xl'/>
            <div>{`${`maximin2023@gmail.com`.slice(0,18)}...`}</div>
            
          <ChevronDownIcon className="-mr-1 h-5 w-5 text-xl" aria-hidden="true" />
        </Menu.Button>
      </div>
